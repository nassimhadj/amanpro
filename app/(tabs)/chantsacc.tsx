...
export default function chantsacc({ navigation }) {
  ...
  useEffect(() => {
    ...
    const fetchaccChantiers = async () => {
      try {
        ...
        const accChantiers = data.filter(rdv => rdv.status === 'attente de demarrage');
        console.log('Filtered en cours chantiers:', accChantiers);
        
        setChantiers(accChantiers);
      } catch (error) {
            ...
            <View key={chantier._id} style={styles.column}>
              ...
              <View style={styles.vbutton}>
                <TouchableOpacity
                  style={styles.button}
                  onPress={() => 
                    navigation.navigate("chantacc", { chantier: chantier })
                  }
                >
